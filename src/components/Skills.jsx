  ...
  return (
    <section id='skills'>
        ...
        <div className="relative z-10 text-center mb-4">
            ...
            <p className="text-gray-300 italic">I am striving to never stop learning and improving</p>
        </div>

        {/* Development Categories */}
        <div className="relative z-10 flex flex-wrap justify-center gap-6 mb-12">
            <div className="bg-teal-200 rounded-lg p-4 flex items-center w-64">
            ...
            <div>
                ...
                <p className="text-gray-600 text-xs italic mt-1">*Currently learning</p>
            </div>
            </div>
        </div>
        ...
        <div className="relative z-10 container mx-auto max-w-5xl">
            ...
            <div>
                ...
                <h3 className="text-white text-xl font-bold mb-4 border-b border-gray-700 pb-2">Backend Development</h3>
                <div className="space-y-5">
                    ...
                    <div key={index} className="mb-2">
                        ...
                        <ProgressBar percentage={skill.percentage} color="bg-orange-500" />
                    </div>
                    ))}
                </div>
                </div>
                ...
                <div className="bg-gray-800/60 backdrop-blur-sm rounded-xl p-6 mb-6">
                <h3 className="text-white text-xl font-bold mb-4 border-b border-gray-700 pb-2">Frontend Development</h3>
                <div className="space-y-5">
                    ...
                    <div key={index} className="mb-2">
                        ...
                        <ProgressBar percentage={skill.percentage} color="bg-blue-500" />
                    </div>
                    ))}
                </div>
                </div>
                ...
                {/* Database */}
                <div className="bg-gray-800/60 backdrop-blur-sm rounded-xl p-6 mb-6">
                <h3 className="text-white text-xl font-bold mb-4 border-b border-gray-700 pb-2">Database</h3>
                <div className="space-y-5">
                    ...
                    <div key={index} className="mb-2">
                        ...
                        <ProgressBar percentage={skill.percentage} color="bg-yellow-500" />
                    </div>
                    ))}
                </div>
                </div>
            ...
            <div className="bg-gray-800/60 backdrop-blur-sm rounded-xl p-6 mt-6">
            <h3 className="text-white text-xl font-bold mb-4 border-b border-gray-700 pb-2">Design and Editing Tools</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div key={index} className="mb-2">
                    ...
                    <ProgressBar percentage={tool.percentage} color="bg-teal-500" />
                </div>
                ))}
            </div>
            </div>
